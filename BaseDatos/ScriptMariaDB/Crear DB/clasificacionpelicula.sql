...
-- Volcando estructura para tabla pelicula.clasificacionpelicula
CREATE TABLE IF NOT EXISTS `clasificacionpelicula` (
  `idclasificacion` bigint(20) NOT NULL COMMENT 'TRIAL',
  `nombreclasificacion` varchar(50) NOT NULL COMMENT 'TRIAL',
  `descripcionclasificacion` varchar(500) NOT NULL COMMENT 'TRIAL',
